...
<div class="lg:px-32 bg-slate-50 min-h-[76vh]">
  <c:if test="${authenticatedUser !=null}">
    <div class="flex flex-row justify-between py-4 ">
      <div class="py-4">
        <h1 class="font-semibold space-y-2 ">List Marks</h1>
        <p class="text-slate-400">List the description of all marks.</p>
      </div>
      <div class="flex flex-row gap-4">
        <button class="bg-indigo-500 text-[14px] flex flex-row gap-4 items-center font-semibold text-white h-10 rounded-md px-6">
          ...
          <a href="createmark.php?page=createMark">New Mark</a>
        </button>
        <button class="bg-indigo-500 text-[14px] flex flex-row gap-4 items-center font-semibold text-white h-10 rounded-md px-6">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
               stroke="currentColor" class="w-6 h-6">
