			...
			<div class="p-6 space-y-4 md:space-y-6 sm:p-8">
				...
				<form class="space-y-4 md:space-y-6" action="login.php" method="post">
					<div>
						...
						<input type="text" name="username" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-indigo-600 focus:border-indigo-600 block w-full p-2.5 " placeholder="name@company.com" required="">
					</div>
					<div>
					...
					<div class="flex items-center justify-between">
						<div class="flex items-start">
							<div class="flex items-center h-5">
								<input id="remember" aria-describedby="remember" type="checkbox" class="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-indigo-300 " required="">
							</div>
					...
					<p class="text-sm font-light text-gray-500 ">
						Don’t have an account yet? <a href="createuser.php?page=createuser" class="font-medium text-indigo-600 hover:underline ">Sign up</a>
					</p>
				</form>
			</div>
		</div>
